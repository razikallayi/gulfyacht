 ...
 <div class="col-md-12 no-padding">
  ...
  <div class="buy-mn nb">
   <div class="row">
    ...
    <div class="row">
      @foreach($brands as $brand)
           <div class="col-md-12 no-padding"><a target="_blank" href="{{$brand->detailPageUrl()}}" class="clearfix"><div class="col-md-4"><div class="buy-img"><img src="{{$brand->imageUrl()}}"></div></div><div class="col-md-8"><h4>{{$brand->name}}</h4><p>{{str_limit($brand->detailPageUrl())}}</p>
